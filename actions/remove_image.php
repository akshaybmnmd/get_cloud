...
// if (copy("../$path", "../../mydisk/$user_id/bin/image/$filename")) {
//     $sql = "UPDATE `images` SET `path` = '../mydisk/$user_id/bin/image/$filename', `action` = 'local_hdd_U_i_r', `action_by` = '$user_id' WHERE `scheduled`.`id` = '$id'";
//     $result = $conn->query($sql);
